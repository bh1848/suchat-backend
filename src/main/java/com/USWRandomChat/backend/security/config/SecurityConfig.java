...
=======
                .antMatchers("/member/sign-up", "/member/sign-in", "/member/confirm-email", "/member/reconfirm-email", "/member/auto-sign-in", "/match/live", "/password-reset/send-verification-code").permitAll()
>>>>>>> Stashed changes
